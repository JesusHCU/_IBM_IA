...
class StressDataGenerator:
    ...
    def generate(self):
        ...
        for hr, cort, sc in zip(heart_rates, cortisol, conductance):
            # Los alumnos deben escribir la lógica para clasificar el nivel de estrés aquí
            # Utilizar if-elif-else para clasificar como "Bajo", "Moderado" o "Alto"
            # --------------------------------
            # Inicio de la zona a rellenar por los alumnos
            # --------------------------------
            if hr > 90 or cort > 18 or sc > 6.5:
                ...
                level = "Bajo"
            # --------------------------------
            # Fin de la zona a rellenar por los alumnos
            # --------------------------------
